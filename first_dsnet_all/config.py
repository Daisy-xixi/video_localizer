...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--set_cost_cls', default=1, type=float,
                    help="dsnet class loss weight")
        parser.add_argument('--set_cost_loc', default=1, type=float,
                    help="dsnet location loss weight")

        # * Loss coefficients
        parser.add_argument('--span_loss_coef', default=0, type=float)
        parser.add_argument('--giou_loss_coef', default=0, type=float)
        parser.add_argument('--label_loss_coef', default=0, type=float)
        ...
        # dsnet中的两个损失函数
        parser.add_argument('--cls_loss_coef', type=float, default=1)
        parser.add_argument('--loc_loss_coef', type=float, default=1)
...
class TestOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--eval_results_dir", type=str, default=None,
                                 help="dir to save results, if notd set, fall back to training results_dir")
