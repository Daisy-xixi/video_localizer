...
def compute_temporal_iou_batch_cross(spans1, spans2):
    ...
    # pred_left = spans1[0][0]
    # pred_right = spans1[0][1]
    # left_max_list = []
    # right_min_list = []
    # import ipdb;ipdb.set_trace()    
    ...
    #     gt_left = spans2[i][0]
    #     gt_right = spans2[i][1]
    #     left_max = max(pred_left, gt_left)
    #     right_min = min(pred_right, gt_right)
    #     left_max_list.append(left_max)
    #     right_min_list.append(right_min)
    # import ipdb;ipdb.set_trace() 
    # iou_list = []
    # union_list = []
    # for i in range(len(left_max_list)):
    #     inter = max(0, right_min_list[i] - left_max_list[i])
